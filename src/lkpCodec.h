...
// struct Format __attribute__ ((__packed__))
// {
//   int32_t  len;
//   int32_t  nameLen;
...
//
class lkpCodec : muduo::noncopyable
{
 public:
  ...
  explicit lkpCodec(const ProtobufMessageCallback& messageCb)
    : messageCallback_(messageCb),
      errorCallback_(defaultErrorCallback)
  {
  }

  lkpCodec(const ProtobufMessageCallback& messageCb, const ErrorCallback& errorCb)
    : messageCallback_(messageCb),
